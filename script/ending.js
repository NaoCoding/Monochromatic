...
async function start_sceneEnding() {
    ...
    await dialogBoxFunction("Brother !!!");
    dialogBox.style("fontFamily:cursive;fontSize:36px;");
    await dialogBoxFunction("Emu !?");
    dialogBox.style("fontFamily:Arial;fontSize:36px;");
    await dialogBoxFunction("You have slept for two days... are you ok?");
    dialogBox.style("fontFamily:cursive;fontSize:36px;");
    await dialogBoxFunction("Wait.... I was sleeping... ?");
    ...
    dialogBox.show();
    dialogBox.style("fontFamily:Arial;fontSize:36px;");
    await dialogBoxFunction("I don't know why the home's door is locked...");
    await dialogBoxFunction("Luckily, Wlick you opened the door!");
    dialogBox.style("fontFamily:cursive;fontSize:36px;");
    await dialogBoxFunction("( You : I hate you.. Emu... )");
    ...
    dialogBox.show();
    dialogBox.style("fontFamily:Arial;fontSize:36px;");
    await dialogBoxFunction("Wlick ~ I want to go home ~");
    await dialogBoxFunction("I still have homeworks to do ~");
    ...
    dialogBox.show();
    dialogBox.style("fontFamily:Arial;fontSize:36px;");
    await dialogBoxFunction("Why you keep asking me to go to the park?");
    await dialogBoxFunction("Are you lying to me?");
    ...
    if (ccct == 1) {
        ...
        dialogBox.show();
        dialogBox.style("fontFamily:Arial;fontSize:36px;");
        await dialogBoxFunction("Alright, let's go to the park!");
        dialogBox.style("fontFamily:cursive;fontSize:36px;");
        await dialogBoxFunction("I love you Emu...");
        dialogBox.hide();
        ...
        await story_tellFunction("I hope you can be happy everyday");
    } else {
        cc = 0;
        t = 1;
        ending_background1.show();
        ...
        dialogBox.show();
        dialogBox.style("fontFamily:Arial;fontSize:36px;");
        await dialogBoxFunction("Sorry Brother... I didn't know your feeling...");
        dialogBox.style("fontFamily:cursive;fontSize:36px;");
        await dialogBoxFunction("Sorry Emu... GoodBye...");
        dialogBox.hide();
        ...
        dialogBox.show();
        dialogBox.style("fontFamily:cursive;fontSize:36px;");
        await dialogBoxFunction("GoodBye... Emu. However, I still hate you...");
        dialogBox.hide();
        ...
        main_menu_startGameBtn.hide();
        story_tellLabel.style("zIndex", "278529375873298523957982375892735892");
        await story_tellFunction("I hope you can be happy in your next life...");
    }
}
