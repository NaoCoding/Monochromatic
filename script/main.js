...
async function startGame() {
    ...
    await story_tellFunction('"Color is everything, black and white is more." - Dominic Rouse');
    ...
    isControlingCharacter = 1;
    dialogBox.show();
    await dialogBoxFunction("Who am I ?? Where is this place ??");
    await dialogBoxFunction("It's so dark here... Wait, I found a flashlight");
    await dialogBoxFunction("I am scared that the battery is dying...");
    await dialogBoxFunction("I must explore the room and find the light switch...");
    moveHint.show();
    dialogBox.hide();
    start_SceneBedroom();
    safeBoxSetup();
